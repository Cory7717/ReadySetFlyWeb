...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[0.95rem] text-sm font-semibold tracking-[0.01em] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-65 disabled:saturate-75 transition-all duration-150 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "border border-border bg-[linear-gradient(180deg,hsl(var(--card)/0.98),hsl(var(--muted)/0.82))] text-foreground shadow-[0px_8px_18px_-16px_rgba(15,23,42,0.26),0px_2px_0px_0px_rgba(73,84,96,0.16)] hover:-translate-y-px hover:bg-[linear-gradient(180deg,hsl(var(--card)),hsl(var(--muted)/0.96))] hover:text-foreground active:translate-y-[1px] active:shadow-[0px_3px_10px_-10px_rgba(15,23,42,0.2),0px_1px_0px_0px_rgba(73,84,96,0.12)]",
        secondary:
        ...
        ghost: "border border-transparent bg-transparent text-foreground shadow-none hover:bg-accent hover:text-accent-foreground",
      },
      size: {
