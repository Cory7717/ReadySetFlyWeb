    ...
    reportUpload.array("opsReport", 8)(req, res, async (error: any) => {
      try {
        ...
        const context = {
          ...
          importTarget: ["weekly_performance", "current_month", "next_month", "guest_satisfaction", "other"].includes(String(req.body?.importTarget || ""))
            ? req.body.importTarget as "weekly_performance" | "current_month" | "next_month" | "guest_satisfaction" | "other"
            : undefined,
        };
