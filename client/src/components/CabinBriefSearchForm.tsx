        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            {(loadingFrom || fromSuggestions.length > 0) && (
              <div className="absolute left-0 right-0 top-[calc(100%+0.35rem)] z-30 rounded-xl border border-white/10 bg-background/95 p-1 shadow-lg backdrop-blur">
                {loadingFrom ? (
                  <div className="px-3 py-2 text-sm text-muted-foreground">Searching airports...</div>
                ) : (
