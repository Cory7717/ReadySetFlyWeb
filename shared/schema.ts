...
export const courtyardMeetingEvents = pgTable("courtyard_meeting_events", {
  ...
  salesOwner: text("sales_owner"), clientName: text("client_name"), clientEmail: text("client_email"), clientPhone: text("client_phone"), expectedRevenue: numeric("expected_revenue", { precision: 12, scale: 2 }), roomRentalRevenue: numeric("room_rental_revenue", { precision: 12, scale: 2 }), taxAmount: numeric("tax_amount", { precision: 12, scale: 2 }), serviceFeeAmount: numeric("service_fee_amount", { precision: 12, scale: 2 }), gratuityAmount: numeric("gratuity_amount", { precision: 12, scale: 2 }), avRevenue: numeric("av_revenue", { precision: 12, scale: 2 }), cateringRevenue: numeric("catering_revenue", { precision: 12, scale: 2 }), otherRevenue: numeric("other_revenue", { precision: 12, scale: 2 }), expectedRoomNights: integer("expected_room_nights"),
