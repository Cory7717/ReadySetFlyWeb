...
function FutureDemandPipeline({ hotelId }: { hotelId: string }) {
  ...
  return <Card className="!border-[#cdbda8] !bg-[#fffaf2] !text-[#201814]">
    ...
    <CardContent className="space-y-5">
      ...
      <div><div className="mb-2 flex items-center justify-between"><h3 className="text-lg font-semibold">Upcoming Demand Generators</h3><Badge variant="outline" className={ADVISOR_FLAG}>{demand.data?.events?.length || 0} verified/manual</Badge></div>
...
export function CourtyardSalesAdvisor({ hotelId }: { hotelId: string }) {
  ...
  return (
    <div className="space-y-4 [&_button]:!border-[#315e49] [&_button]:!bg-white [&_button]:!text-[#173b2a] [&_button:hover]:!bg-[#e7f0e9] [&_button:disabled]:!border-[#8d8278] [&_button:disabled]:!bg-[#e6ded3] [&_button:disabled]:!text-[#5a5048] [&_.rounded-full]:!border-[#6f5a43] [&_.rounded-full]:!bg-[#fffaf2] [&_.rounded-full]:!text-[#2b2119]">
