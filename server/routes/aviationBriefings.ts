...
function mapInput(input: AviationBriefingInput, userId: string | null) {
  ...
  return {
    ...
    featuredImageCreditUrl: input.featuredImageCreditUrl || null,
...
function publicBriefing(row: typeof aviationBriefings.$inferSelect) {
  return {
    ...
    featuredImageAlt: row.featuredImageAlt, featuredImageCredit: row.featuredImageCredit,
    featuredImageCreditUrl: row.featuredImageCreditUrl, articleContent: row.articleContentJson,
