  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        ...
        >
          <Ionicons name="cloud-outline" size={28} color="#1e40af" />
          <View style={styles.cardText}>
            <Text style={styles.cardTitle}>Aviation Weather Hub</Text>
            <Text style={styles.cardSubtitle}>NOAA/AWC METARs, TAFs, NOTAMs, PIREPs, hazards.</Text>
          </View>
