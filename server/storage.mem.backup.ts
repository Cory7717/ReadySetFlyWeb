...
export class MemStorage implements IStorage {
  ...
  async createUser(insertUser: InsertUser): Promise<User> {
    ...
    const user: User = {
      ...
      weeklyEmailOptIn: insertUser.weeklyEmailOptIn ?? true,
      weeklyEmailLastSentAt: insertUser.weeklyEmailLastSentAt || null,
      weeklyEmailOptOutAt: insertUser.weeklyEmailOptOutAt || null,
