...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(37,99,235,0.16),_transparent_32%),linear-gradient(135deg,#f6fbff,#eef4ff_52%,#f8fafc)] p-4">
      <div className="mx-auto grid min-h-screen max-w-5xl items-center gap-6 py-8 lg:grid-cols-[1.02fr_0.98fr]">
        <div className="rounded-[2rem] border border-sky-100 bg-[linear-gradient(160deg,rgba(15,23,42,0.96),rgba(30,64,175,0.92))] p-6 text-white shadow-[0_24px_60px_rgba(15,23,42,0.18)] sm:p-8">
          ...
          <div className="mt-6 space-y-3">
            <div className="text-xs font-semibold uppercase tracking-[0.26em] text-sky-100/80">Welcome Back</div>
        ...
        <Card className="w-full border-white/70 bg-white/92 shadow-[0_24px_60px_rgba(15,23,42,0.12)]">
          <CardHeader className="space-y-2 text-center">
            <CardTitle className="text-2xl font-bold">Sign in to RSF</CardTitle>
            <CardDescription>
              Continue your saved workflow across planning, logbook, training, and marketplace.
            </CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex flex-col space-y-4">
            <div className="text-sm text-center text-muted-foreground">
              ...
              <button
                onClick={() => setLocation(withReturnTo('/register', redirectTarget))}
